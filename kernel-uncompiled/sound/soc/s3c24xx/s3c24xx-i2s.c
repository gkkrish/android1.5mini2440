				 ...
				 struct snd_soc_dai *dai)
{
	...
	printk("hw_params r: iiscon: %lx\n", iiscon);
	printk("hw_params r: IISMOD: %lx\n", iismod);
	printk("hw_params r: iisfcon: %lx\n", iisfcon);
	printk("hw_params r: iispsr: %lx\n", iispsr);
	
	printk("channel:%d,runtime channel:%d\n",params_channels(params),substream->runtime->channels);
	params_channels(params) = 2;substream->runtime->channels = 2;
